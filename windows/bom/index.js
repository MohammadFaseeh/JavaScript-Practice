...
// 1. window: Top-level object of BOM, represents the browser window
// 2. navigator: Info about the browser (name, version, platform)
// 3. screen: Info about the user's screen (width, height, etc.)
// 4. location: Current URL and methods to change it
// 5. history: Browser history (back, forward)
